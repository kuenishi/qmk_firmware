 ...
 * |------+------+------+------+------+------+------|          |------+------+------+------+------+------+------|
 * | META | ESC  | LGUI | LAlt | Bksp |Space |Space |          |Space | Entr |      |                    | SYMB |
 * `------------------------------------------------'          `------------------------------------------------'
 */

[BASE] = KEYMAP( \
  KC_TAB,  KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,   KC_ESC,   KC_Y,   KC_U,   KC_I,    KC_O,   KC_P,    KC_LBRC, KC_RBRC, \
  KC_LCTL, KC_A,   KC_S,    KC_D,    KC_F,    KC_G,   XXXXXXX,  KC_H,   KC_J,   KC_K,    KC_L,   KC_SCLN, KC_QUOT, KC_BSLS, \
  KC_LSFT, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,   XXXXXXX,  KC_N,   KC_M,   KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_RSFT, \
  MO(META),KC_ESC, KC_LGUI, KC_LALT, KC_BSPC,KC_SPC,  KC_SPC,  KC_SPC, KC_ENT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, MO(SYMB) \
),
...
[SYMB] = KEYMAP( \
  S(KC_GRV),S(KC_1), S(KC_2), S(KC_3), S(KC_4), S(KC_5), _______,   S(KC_6), S(KC_7), S(KC_8), S(KC_9), S(KC_0), S(KC_MINS), S(KC_EQL), \
